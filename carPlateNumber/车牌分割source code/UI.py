...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_6.setGeometry(QtCore.QRect(710, 492, 150, 50))
        icon4 = QtGui.QIcon()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "plate recognition system"))
        self.pushButton.setText(_translate("MainWindow", "-"))
        self.pushButton_2.setText(_translate("MainWindow", "✘"))
        self.pushButton_3.setText(_translate("MainWindow", "plate detection"))
        self.pushButton_4.setText(_translate("MainWindow", "plate recognition"))
        self.pushButton_5.setText(_translate("MainWindow", "plate color"))
        self.pushButton_6.setText(_translate("MainWindow", "Load Image"))
        # self.pushButton_7.setText(_translate("MainWindow", "Video"))
        self.pushButton_8.setText(_translate("MainWindow", "plate recognition system"))
